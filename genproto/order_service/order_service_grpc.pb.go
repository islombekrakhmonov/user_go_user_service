...
func (c *orderServiceClient) GetById(ctx context.Context, in *OrderPKey, opts ...grpc.CallOption) (*Order, error) {
	out := new(Order)
...
func (c *orderServiceClient) Delete(ctx context.Context, in *OrderPKey, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (UnimplementedOrderServiceServer) GetById(context.Context, *OrderPKey) (*Order, error) {
...
func _OrderService_GetById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).GetById(ctx, req.(*OrderPKey))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _OrderService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).Delete(ctx, req.(*OrderPKey))
	}
	return interceptor(ctx, in, info, handler)
}
